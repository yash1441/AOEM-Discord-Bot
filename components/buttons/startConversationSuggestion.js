...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.channel.send({ content: 'Please give a detailed description of your feedback and suggestion, preferably with a screenshot to help us quickly locate the features or systems in your description.' });
        ...
        await interaction.channel.send({ content: 'Could you rate the importance of the suggestions you have provided? Reference: 1 star (not important) -5 stars (very important, greatly helpful for improving game experience)' });
        ...
        if (timedOut) {
            await interaction.channel.send({ content: 'You did not provide rating in time. This thread will be deleted.' });
            setTimeout(function () {
                interaction.channel.delete().catch();
            }, 2_000);
        }

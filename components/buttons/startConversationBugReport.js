...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await Sheets.appendRow(process.env.FEEDBACK_SHEET, 'Bug!A2:Z', [[interaction.user.id, interaction.user.username, userData.governorId, userData.details, userData.deviceInfo, userData.timeOfOccurence, date.format(now, 'MM-DD-YYYY HH:mm [GMT]ZZ'), userData.screenshotFunction]]);
